...
class GXContainerViewAdapter(
    ...
    override fun onBindViewHolder(holder: GXViewHolder, position: Int) {
        ...
        val childVisualNestTemplateNode = holder.childVisualNestTemplateNode
            ?: throw IllegalArgumentException("childVisualNestTemplateNode is null")
        val childMeasureSize =
    ...
    override fun getItemViewType(position: Int): Int {
        ...
        if (mItemFooterTypeHasMore && itemFooterTypeId != null && position == containerData.size) {
            ...
            gxNode.childTemplateItems?.add(
                Pair(
                    itemFooterTypeId,
                    GXTemplateNode.createNode(
                        gxTemplateContext.templateInfo.layer.layers[0].id,
    ...
    fun setContainerBinding(binding: GXDataBinding?) {

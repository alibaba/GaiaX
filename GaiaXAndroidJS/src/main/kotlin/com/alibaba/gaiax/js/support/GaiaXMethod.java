...
public final class GaiaXMethod {
    ...
    public static GaiaXMethod create(Type type, java.lang.reflect.Method rawMethod) {
        ...
        return new GaiaXMethod(returnType, name, parameterTypes);
    }
    ...
    public GaiaXMethod(Type returnType, String name, Type[] parameterTypes) {
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof GaiaXMethod)) return false;
        GaiaXMethod other = (GaiaXMethod) obj;

...
@implementation GXPagerLayoutConfig
...
#pragma mark -
#pragma mark - GaiaSliderLayout

@interface GXPagerLayout () {
    struct {
...
- (void)setDelegate:(id<GXPagerLayoutDelegate>)delegate {
    _delegate = delegate;
...
- (void)setLayout:(GXPagerLayoutConfig *)layout {
    _layout = layout;
...
-(BOOL)shouldInvalidateLayoutForBoundsChange:(CGRect)newBounds {
    return _layout.layoutType == GXPagerLayoutTypeNormal ? [super shouldInvalidateLayoutForBoundsChange:newBounds] : YES;
}

- (NSArray<UICollectionViewLayoutAttributes *> *)layoutAttributesForElementsInRect:(CGRect)rect {
    if (_delegateFlags.applyTransformToAttributes ||
        _layout.layoutType != GXPagerLayoutTypeNormal) {
...
- (UICollectionViewLayoutAttributes *)layoutAttributesForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    }else if(_layout.layoutType != GXPagerLayoutTypeNormal){
...
- (void)initializeTransformAttributes:(UICollectionViewLayoutAttributes *)attributes layoutType:(GXPagerLayoutType)layoutType {
    switch (layoutType) {
        case GXPagerLayoutTypeLinear:           
            [self applyLinearTransformToAttributes:attributes scale:_layout.minimumScale alpha:_layout.minimumAlpha];
            break;
        case GXPagerLayoutTypeCoverflow:
...
- (void)applyTransformToAttributes:(UICollectionViewLayoutAttributes *)attributes layoutType:(GXPagerLayoutType)layoutType {
    switch (layoutType) {
        case GXPagerLayoutTypeLinear:

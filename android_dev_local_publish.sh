...
chmod +rx ./gradlew && ./gradlew assembleDebug clean assembleDebug -Ptype="debug" -Pgroup="com.github.alibaba.GaiaX" -Pversion="dev-20231011-SNAPSHOT" -xtest -xlint publishToMavenLocal

 ...
 *  Description:
 */
class GaiaXJSPreferenceUtil private constructor(context: Context?, sharePreFileName: String) {
    ...
    init {
        ...
        synchronized(GaiaXJSPreferenceUtil::class.java) {
    ...
    companion object {
        ...
        fun createSharePreference(fileName: String): GaiaXJSPreferenceUtil {
            if (Log.isLog()) {
